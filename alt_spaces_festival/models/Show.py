...
from utils.code_utils import upload_to_alt_spaces_festival_show
...
class Show(models.Model):
    ...
    poster = models.FileField(
        upload_to=upload_to_alt_spaces_festival_show, null=True, blank=True
    )
    ...
    def reservation_status(self):
        from alt_spaces_festival.models.Reservation import ReservationStatus
