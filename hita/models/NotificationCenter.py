...
class NotificationCenter(models.Model):
    performer = models.ForeignKey(HITAMember, on_delete=models.CASCADE, related_name='notifications')
    request_from = models.ForeignKey(HITAMember, on_delete=models.DO_NOTHING, related_name='requests')
    ...
    status = models.CharField(max_length=20, choices=RequestStatus, default=RequestStatus.PENDING.value)
